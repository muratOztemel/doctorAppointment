...
import { useGetByDoctorAndDateQuery } from "../../../redux/features/api/apiSlice.js";
...
import { setDoctorId } from "../../../redux/slices/tableDoctorAppointmentSlice.js";

const DoctorHomePage = () => {
  const [appointmentsPage, setAppointmentsPage] = useState(1);

  const dispatch = useDispatch();
  const { doctorId, searchTerm, sortField, sortOrder, filter } = useSelector(
    (state) => state.tableDoctorAppointment
  );
