  ...
  const linkDizi = [
    {
      ...
      path: `/dashboard/doctor/patient/${patientId}/${patientName}`,
      icon: <FaUserInjured />,
      end: true,
    },
    {
      ...
      path: `/dashboard/doctor/patientAppointments/${patientId}/${patientName}`,
      icon: <FaRegCalendarDays />,
    },
    {
      id: 3,
      name: "Medical Records",
      path: `/dashboard/doctor/medicalRecords/${patientId}/${patientName}`,
