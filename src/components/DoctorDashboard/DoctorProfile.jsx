...
const DoctorProfile = () => {
  ...
  return (
    <div className="p-4 md:p-4">
      ...
      <div className="mt-6 bg-white rounded-xl border border-gray-300 p-6">
        <form
          ...
          <div className="flex flex-col col-span-1 md:col-span-3">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div
                className="px-6 py-5 border-2 border-dashed border-cyan-100 rounded-md cursor-pointer"
                role="presentation"
                tabIndex="0">
                <input
                  type="file"
              ...
              <div className="flex justify-center items-center w-full md:w-36 h-36">
                {preview ? (
                  <img
                    src={preview}
                    alt="Preview"
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full col-span-3">
