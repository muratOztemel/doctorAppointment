...
import DoctorAppointmentsList from "./DoctorAppointmentsList.jsx";
  ...
  return (
    <>
      <div className="xl:px-8 px-2">
        ...
        <div className="grid grid-cols-12 gap-6 my-8 items-start w-full">
          ...
          <div className="grid gap-3 lg:col-span-8 bg-white rounded-xl border-[1px] p-6">
