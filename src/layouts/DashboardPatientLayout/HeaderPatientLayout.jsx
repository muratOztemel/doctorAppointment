...
import useFutureAppointments from "../../components/hooks/useFutureAppointments";
    ...
    <>
      <div className="fixed w-full flex items-center justify-between h-14 bg-white text-black z-10 ">
        ...
        <div className="flex justify-between items-center w-full h-14 ml-2">
          <div className="bg-white rounded flex items-center w-full max-w-xl mr-4 p-2 border-gray-200 md:ml-8">
