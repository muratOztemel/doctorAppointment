import DoctorPatientVisiting from "../../components/DoctorDashboard/DoctorPatientVisiting";
import TitleCard from "../../components/UI/Cards/TitleCard";

const DashboardDoctorVisiting = () => {
  return (
    <>
      <div className="xl:px-8 px-2">
        <div className="w-full my-6 grid xl:grid-cols-8 grid-cols-1 gap-6">
          <div className="xl:col-span-12 w-full">
            <DoctorPatientVisiting />
          </div>
...
export default DashboardDoctorVisiting;
